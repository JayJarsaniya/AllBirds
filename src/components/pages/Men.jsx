...
import './style/Filterbycategory.css'
...
const Men = ({ products }) => {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    return product.category === 'men' && matchesPrice && matchesSubCategory;
  });
    ...
    <div className="main-page-container">
      <div className="filter-container">
        <div className="price-filter-container">
          <h5 className="mb-3 price-filter-heading">FILTER BY PRICE</h5>
          ...
          <div className="category-shorting">
            ...
            {['Everyday Sneakers', 'Active Shoes', 'Water-Repellent Shoes', 'Slip-Ons', 'Hiking Shoes', 'Sale Shoes'].map((subCategory) => (
              <button
                key={subCategory}
